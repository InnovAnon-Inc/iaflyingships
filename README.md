# iaflyingships [![luacheck][luacheck badge]][luacheck workflow]  
IA Flying Ships Redo
==========
...
It's janky and I probably won't do anything more with it, since I'm using `jumpdrive` again.
